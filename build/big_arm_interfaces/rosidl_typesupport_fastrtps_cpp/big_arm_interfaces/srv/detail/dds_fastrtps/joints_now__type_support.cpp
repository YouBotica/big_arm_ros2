  ...
  size_t current_alignment)
{
  ...
  // Member: g2
  {
    size_t item_size = sizeof(ros_message.g2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: g22
  {
    size_t item_size = sizeof(ros_message.g22);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: g4
  {
    size_t item_size = sizeof(ros_message.g4);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: g44
  {
    size_t item_size = sizeof(ros_message.g44);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
