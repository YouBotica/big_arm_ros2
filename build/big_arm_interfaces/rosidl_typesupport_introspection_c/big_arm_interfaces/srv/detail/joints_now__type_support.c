...
static rosidl_typesupport_introspection_c__MessageMember JointsNow_Response__rosidl_typesupport_introspection_c__JointsNow_Response_message_member_array[7] = {
  {
    "success",  // name
