...
bool big_arm_interfaces__srv__joints_now__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // g2
    ...
    assert(PyFloat_Check(field));
    ros_message->g2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // g22
    PyObject * field = PyObject_GetAttrString(_pymsg, "g22");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->g22 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // g4
    PyObject * field = PyObject_GetAttrString(_pymsg, "g4");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->g4 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // g44
    PyObject * field = PyObject_GetAttrString(_pymsg, "g44");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->g44 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * big_arm_interfaces__srv__joints_now__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // g2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->g2);
    {
  ...
  {  // g22
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->g22);
    {
      int rc = PyObject_SetAttrString(_pymessage, "g22", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // g4
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->g4);
    {
      int rc = PyObject_SetAttrString(_pymessage, "g4", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // g44
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->g44);
    {
      int rc = PyObject_SetAttrString(_pymessage, "g44", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
