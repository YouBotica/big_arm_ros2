...
class JointsNow_Response(metaclass=Metaclass_JointsNow_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.g2 = kwargs.get('g2', float())
        self.g22 = kwargs.get('g22', float())
        self.g4 = kwargs.get('g4', float())
        self.g44 = kwargs.get('g44', float())
    ...
    def __eq__(self, other):
        ...
        if self.g2 != other.g2:
            return False
        if self.g22 != other.g22:
            return False
        if self.g4 != other.g4:
            return False
        if self.g44 != other.g44:
            return False
        return True
    ...
    def g2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'g2' field must be of type 'float'"
        self._g2 = value
    ...
    def g22(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'g22' field must be of type 'float'"
        self._g22 = value
    ...
    def g4(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'g4' field must be of type 'float'"
        self._g4 = value
    ...
    def g44(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'g44' field must be of type 'float'"
        self._g44 = value
